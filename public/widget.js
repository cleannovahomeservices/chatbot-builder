(function () {
  ...
  var iconPaths = {
    ...
    dots:   '<path d="M20 2H4C2.9 2 2 2.9 2 4v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM8.5 12c-.83 0-1.5-.67-1.5-1.5S7.67 9 8.5 9 10 9.67 10 10.5 9.33 12 8.5 12zm3.5 0c-.83 0-1.5-.67-1.5-1.5S11.17 9 12 9s1.5.67 1.5 1.5S12.83 12 12 12zm3.5 0c-.83 0-1.5-.67-1.5-1.5S15.17 9 15.5 9 17 9.67 17 10.5 16.33 12 15.5 12z"/>',
    single: '<path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/>',
    forum:  '<path d="M21 6h-2v9H6v2c0 1.1.9 2 2 2h11l4 4V8c0-1.1-.9-2-2-2zm-4-4H2C.9 2 0 2.9 0 4v15.17L3.17 16H17c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/>',
    pair:   '<path d="M16 17.01V13c0-.55-.45-1-1-1H5c-.55 0-1 .45-1 1v8l4-4h7c.55 0 1-.45 1-1zm4-14H9c-.55 0-1 .45-1 1v2h7c1.1 0 2 .9 2 2v6h2c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1z"/>',
  };
